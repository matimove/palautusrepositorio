...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_yhdellä_ostoksella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_kahdella_eri_ostoksella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_kahdella_samalla_ostoksella(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tilisiirto_kutsutaan_oikeilla_arvoilla_kahdella_eri_ostoksella_toinen_loppu_varastosta(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_nollaa_ostokset(self):
        ...
        kauppa.aloita_asiointi() # TARKASTETAAN ETTÄ NOLLAUS TOIMII TÄSSÄKOHTAA
        kauppa.lisaa_koriin(2)
        kauppa.tilimaksu("pekka", "12345")
